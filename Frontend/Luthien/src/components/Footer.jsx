        ...
        <footer className={styles["footer"]}>
            ...
            <div className={styles["content"]}>
                <div className={styles["company"]}>
                    ...
                    <Logo size={80} />
                    <p>
                        Lothian is a place where you can find your favorite
                        hotel in the desired city with specific prices.
                    </p>
                </div>
                <div className={styles["links"]}>
                    ...
                    <div className={styles["link-container"]}>
                        ...
                        <NavLink>Domestic Hoteld</NavLink>
                        <NavLink>Foreign Hoteld</NavLink>
                        <NavLink>Trending Destinations</NavLink>
                    </div>
                </div>
