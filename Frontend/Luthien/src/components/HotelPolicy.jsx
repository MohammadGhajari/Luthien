    ...
    <div id="hotel-policy" className={styles["container"]}>
      ...
      <div className={styles["right"]}>
        ...
        >
          ...
          <ul>
            <li>
              <strong>Continental breakfast</strong> is offered for an extra
              charge of approximately USD 14.95 per person
            </li>
          </ul>
        </div>
        <div
        ...
        >
          ...
          <ul>
            ...
            <li>
              Pets are allowed for an extra charge of USD 100.00 per
        ...
        >
          ...
          <ul>
            ...
            <li>
              Parking is available nearby and costs USD 50 per day (984 ft away)
            </li>
        ...
        >
          ...
          <ul>
            <li>
              The property has connecting/adjoining rooms. These are subject to
              availability and can be requested by contacting the property using
              the number on the booking confirmation.
            </li>
            <li>
              This property's policy is to refuse certain bookings for the
              purpose of group events or parties, including pre-wedding stag and
              hen parties.
            </li>
            <li>
              Guests can rest easy knowing that there's a fire extinguisher, a
              security system and window guards on-site.
            </li>
            <li>
            ...
            <li>
              ...
              disinfection practices of Commitment to Clean (Marriott).
            </li>
